* Open log file
local dofile_name "mismatch_u45"
...
keep if inlist(1, age25_29, age30_34, age35_39, age40_44)
	...
	foreach tag in _paid_year _protect_year {
		...
		* CBA
		...
		forvalues i = 1(1)2 {
			...
			local texfile "${path_table}/tex/sub/mismatch_`skill'`tag'`tag`i''_u45_sub.tex"
